...
const Allbranch = () => {
  return (
    <div className='allbranch'>
     <div className="left">
     <Link to={`/admin/branch/${'ernakulam'}`}>
      <div className="pic">
     <img src={Ernakulam} alt="" className="userImg"  /></div>
    <div className="name"><h2 className='ernakulam'> Ernakulam</h2></div>
    </Link>
     </div>
     <div className="center">
     <Link to={`/admin/branch/${'calicut'}`}>
     <div className="pic">
     <img src={Calicut} alt="" className="userImg" /></div>
     <div className="name"><h2 className='ernakulam'> Calicut</h2></div>
     </Link>
     </div>
     <div className="right">
     <Link to={`/admin/branch/${'trivandrum'}`}>
     <div className="pic">
     <img src={TVM} alt="" className="userImg" /></div>
     <div className="name"><h2 className='ernakulam'> Trivandrum</h2></div>
     </Link>
     </div> 
    </div>
  )
