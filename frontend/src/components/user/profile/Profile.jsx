    ...
    <div  className='usersingle'>
      ...
      <div className="usersingleCntainer">
        ...
        <AccordionDetails>
          ...
          <div>{user.week ? <span className='details'> week  : &nbsp;{user.week} </span>  :" "}</div>   
      ...
      <Accordion>
        <AccordionSummary
          ...
          className={classes.accordi}
        >
          <Typography className={classes.heading}>Educational details</Typography>
        </AccordionSummary>
        <AccordionDetails>
          <Typography>
      ...
      <Accordion>
        <AccordionSummary
          ...
          className={classes.accordi}
        >
          <Typography className={classes.heading}>Family Details</Typography>
        </AccordionSummary>
        <AccordionDetails>
          <Typography>
      ...
      <Accordion>
        <AccordionSummary
          ...
          className={classes.accordi}
        >
          <Typography className={classes.heading}>Career Informations</Typography>
        </AccordionSummary>
        <AccordionDetails>
          <Typography>
